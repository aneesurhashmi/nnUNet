...
# nnUNetv2_train 001 3d_fullres 0 -tr nnUNetTrainerUNETR
# nnUNetv2_train 001 3d_fullres 1 -tr nnUNetTrainerUNETR
# nnUNetv2_train 001 3d_fullres 2 -tr nnUNetTrainerUNETR

nnUNetv2_train 001 3d_fullres 3 -tr nnUNetTrainerUNETR
nnUNetv2_train 001 3d_fullres 4 -tr nnUNetTrainerUNETR